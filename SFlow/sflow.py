...
class sFlowSample:
    ...
    sequenceNumber:  Incremented with each flow sample generated by
        this source_id.
    ...
    drops:  Number of times that the sFlow agent detected that a packet
        marked to be sampled was dropped due to lack of resources.
    ...
    def __init__(self, dataGram):
        ...
        if self.NumberSample > 0:
            for _ in range(self.NumberSample):
                # [0:4]header,[4:8]size,[8:8+size]datagram
...
class sFlowOfPort():
    ...
    def __init__(self, length, dataGram):
        self.len = length
        self.data = dataGram
        self.datapathId = unpack('>q', dataGram[0:8])[0]
